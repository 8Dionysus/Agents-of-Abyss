...
| `ORQ-BRIDGE-ROUTING-001` | `aoa-sdk` | `requested` | `P1` | Boundary-aware handoff and bridge route surfaces | Thin dispatch surface from AoA routes into owner-owned seams without semantic override. | Route behavior proof routes to `aoa-evals` when needed. |
