...
| `ORQ-AGON-ROUTING-001` | `aoa-sdk` | `requested` | `P1` | Gates, handoffs, and arena route behavior | Dispatch and gate surfaces that route between trial, proof, memory, role, runtime, and ToS thresholds. | Route behavior proof may route to `aoa-evals`. |
