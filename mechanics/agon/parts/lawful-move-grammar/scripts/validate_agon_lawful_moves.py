...
ROOT = _repo_root()
BUILDER_PATH = ROOT / "mechanics" / "agon" / "parts" / "lawful-move-grammar" / "scripts" / "build_agon_lawful_move_registry.py"
GENERATED = ROOT / "mechanics" / "agon" / "parts" / "lawful-move-grammar" / "generated" / "agon_lawful_move_registry.min.json"
...
def main() -> int:
    ...
    if existing != expected:
        fail("mechanics/agon/parts/lawful-move-grammar/generated/agon_lawful_move_registry.min.json is stale; run mechanics/agon/parts/lawful-move-grammar/scripts/build_agon_lawful_move_registry.py")
