...
ROOT = _repo_root()
CONFIG = ROOT / 'mechanics/agon/parts/verdict-retention-rank/config/agon_court_memo_stats_prebinding_request.seed.json'
GENERATED = ROOT / 'mechanics/agon/parts/verdict-retention-rank/generated/agon_court_memo_stats_prebinding_request.min.json'
RECORD_KEY = 'owner_requests'
BUILDER = ROOT / "mechanics" / "agon" / "parts" / "verdict-retention-rank" / "scripts" / "build_agon_court_memo_stats_prebinding_request.py"
