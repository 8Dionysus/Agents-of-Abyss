...
ROOT = _repo_root()
CONFIG = ROOT / "mechanics/agon/parts/verdict-retention-rank/config/agon_retention_rank_economy.seed.json"
OUTPUT = ROOT / "mechanics/agon/parts/verdict-retention-rank/generated/agon_retention_rank_economy_registry.min.json"
...
def build_registry():
    ...
    return {
        ...
        "source_config": "mechanics/agon/parts/verdict-retention-rank/config/agon_retention_rank_economy.seed.json",
