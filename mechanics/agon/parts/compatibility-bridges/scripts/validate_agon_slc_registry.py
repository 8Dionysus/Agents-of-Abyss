...
ROOT = _repo_root()
SRC = ROOT / 'mechanics/agon/parts/compatibility-bridges/config/agon_slc.seed.json'
...
BUILDER = ROOT / "mechanics" / "agon" / "parts" / "compatibility-bridges" / "scripts" / "build_agon_slc_registry.py"
