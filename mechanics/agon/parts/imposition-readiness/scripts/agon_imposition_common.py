...
READINESS_PATH = REPO_ROOT / "mechanics" / "agon" / "parts" / "imposition-readiness" / "generated" / "agon_imposition_readiness.min.json"
...
def main_build(argv: list[str] | None = None) -> int:
    ...
    if args.check:
        ...
        if current != expected:
            raise SystemExit("mechanics/agon/parts/imposition-readiness/generated/agon_imposition_readiness.min.json is stale; rebuild it")
        print("[ok] mechanics/agon/parts/imposition-readiness/generated/agon_imposition_readiness.min.json is current")
        return 0
...
def main_validate() -> int:
    ...
    if payload != expected:
        raise SystemExit("mechanics/agon/parts/imposition-readiness/generated/agon_imposition_readiness.min.json does not match canonical rebuild")
    print("[ok] validated mechanics/agon/parts/imposition-readiness/generated/agon_imposition_readiness.min.json")
    return 0
