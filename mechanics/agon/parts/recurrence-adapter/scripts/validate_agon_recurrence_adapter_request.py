...
ROOT = _repo_root()
REQ = ROOT / "mechanics" / "agon" / "parts" / "recurrence-adapter" / "generated" / "agon_recurrence_adapter_request.min.json"
...
def main() -> int:
    builder = ROOT / "mechanics" / "agon" / "parts" / "recurrence-adapter" / "scripts" / "build_agon_recurrence_adapter_request.py"
