...
ROOT = _repo_root()
SRC = ROOT / 'mechanics/agon/parts/epistemic-kag/config/agon_kag_promotion_path.seed.json'
OUT = ROOT / 'mechanics/agon/parts/epistemic-kag/generated/agon_kag_promotion_path_registry.min.json'
ENTRY_SCHEMA = ROOT / 'mechanics/agon/parts/epistemic-kag/schemas/agon-kag-promotion-path.schema.json'
REGISTRY_SCHEMA = ROOT / 'mechanics/agon/parts/epistemic-kag/schemas/agon-kag-promotion-path-registry.schema.json'
BUILDER = ROOT / 'mechanics/agon/parts/epistemic-kag/scripts/build_agon_kag_promotion_path_registry.py'
