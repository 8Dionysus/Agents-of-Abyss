...
ROOT = _repo_root()
REQ = ROOT / "mechanics" / "agon" / "parts" / "trial-handoff" / "generated" / "agon_trial_playbook_request.min.json"
REQUIRED_STOP_LINES = {
...
def main() -> int:
    builder = ROOT / "mechanics" / "agon" / "parts" / "trial-handoff" / "scripts" / "build_agon_trial_playbook_request.py"
