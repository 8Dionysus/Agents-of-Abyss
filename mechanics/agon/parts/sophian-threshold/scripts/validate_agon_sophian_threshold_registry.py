...
ROOT = _repo_root()
SRC = ROOT / 'mechanics/agon/parts/sophian-threshold/config/agon_sophian_threshold.seed.json'
OUT = ROOT / 'mechanics/agon/parts/sophian-threshold/generated/agon_sophian_threshold_registry.min.json'
ENTRY_SCHEMA = ROOT / 'mechanics/agon/parts/sophian-threshold/schemas/agon-sophian-threshold.schema.json'
REGISTRY_SCHEMA = ROOT / 'mechanics/agon/parts/sophian-threshold/schemas/agon-sophian-threshold-registry.schema.json'
