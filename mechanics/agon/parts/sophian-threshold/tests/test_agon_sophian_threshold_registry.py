...
ROOT = _repo_root()
GENERATED = ROOT / 'mechanics/agon/parts/sophian-threshold/generated/agon_sophian_threshold_registry.min.json'
SCRIPT = ROOT / 'mechanics/agon/parts/sophian-threshold/scripts/build_agon_sophian_threshold_registry.py'
VALIDATOR = ROOT / 'mechanics/agon/parts/sophian-threshold/scripts/validate_agon_sophian_threshold_registry.py'
EXPECTED_COUNT = 10
