...
This card applies to `mechanics/recurrence/docs/` and all descendant source documents.
...
`mechanics/recurrence/README.md`, and the specific source document you are changing. If a generated
