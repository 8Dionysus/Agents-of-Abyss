...
The package owns questbook mechanics while `QUESTBOOK.md` remains the root
public index and `quests/` remains the item store.

## Next Work

- Keep quest lifecycle law aligned with the root public index.
- Avoid turning questbook into roadmap history.
- Add generated summaries only after a real builder and validator exist.
