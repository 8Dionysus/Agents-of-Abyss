...
1. use `mechanics/method-growth/docs/REVIEWABLE_GROWTH_REFINERY.md` to restore the route
2. use `mechanics/method-growth/docs/CANDIDATE_LINEAGE_CROSSWALK.md` to restore stage ownership
