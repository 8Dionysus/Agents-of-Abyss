...
before `method-growth` may be treated as operational beyond center doctrine,
...
| `ORQ-METHOD-TECHNIQUES-001` | `aoa-techniques` | `requested` | `P1` | Reusable practice promotion | Technique-owned reusable practice with procedure, boundaries, examples, and canonical-readiness posture. | Technique quality claims route to `aoa-evals` before public promotion. |
| `ORQ-METHOD-STATS-001` | `aoa-stats` | `requested` | `P2` | Derived method-growth visibility | Derived summaries that read owner receipts without becoming route, proof, memory, or landing authority. | Derived counts stay weaker than owner receipts and route to `aoa-evals` for public quality claims. |
...
- [METHOD_SPINE.md](docs/METHOD_SPINE.md)
- [REVIEWABLE_GROWTH_REFINERY.md](docs/REVIEWABLE_GROWTH_REFINERY.md)
- [OWNER_LANDING_AND_PRUNING.md](docs/OWNER_LANDING_AND_PRUNING.md)
...
- `ORQ-METHOD-TECHNIQUES-001`: The center must not become reusable-practice canon.
- `ORQ-METHOD-STATS-001`: The center must not treat derived growth summaries as proof, route authority, memory, or owner-local truth.
