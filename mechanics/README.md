...
| Audit | What needs to be seen, evidenced, risk-routed, validated, or handed to an owner? | planted center route package | [README](audit/README.md), [PARTS](audit/PARTS.md), [AUDIT_LAW](audit/docs/AUDIT_LAW.md), [OWNER_REQUESTS](audit/OWNER_REQUESTS.md) | proof verdict, owner-local remediation, memory truth, runtime authority, or archive evidence as active law |
...
| [agon](agon/README.md) | [PARTS](agon/PARTS.md), [DIRECTION](agon/DIRECTION.md), [LANDING_LOG](agon/LANDING_LOG.md), [PROVENANCE](agon/PROVENANCE.md), [legacy index](https://github.com/8Dionysus/Agents-of-Abyss/blob/d31882083296ef457a980d071f55d609e95cce67/mechanics/agon/legacy/INDEX.md) |
| [antifragility](antifragility/README.md) | [ANTIFRAGILITY](antifragility/docs/ANTIFRAGILITY.md), [VIA_NEGATIVA](antifragility/docs/VIA_NEGATIVA.md), [ANTI_AUTHORITY_RULES](antifragility/docs/ANTI_AUTHORITY_RULES.md), [ONE_IN_ONE_OUT](antifragility/docs/ONE_IN_ONE_OUT.md), [FRAGILITY_BLACKLIST](antifragility/FRAGILITY_BLACKLIST.md), [DELETION_CANDIDATES.json provenance](audit/PROVENANCE.md) |
...
| [audit](audit/README.md) | [AUDIT_LAW](audit/docs/AUDIT_LAW.md), [PARTS](audit/PARTS.md), [PROVENANCE](audit/PROVENANCE.md), [OWNER_REQUESTS](audit/OWNER_REQUESTS.md) |
