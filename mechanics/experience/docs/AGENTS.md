...
This card applies to `mechanics/experience/docs/` and all descendant source documents.

## Role

`mechanics/experience/docs/` holds detailed center-source doctrine, models, waves, stop-lines,
handoffs, packets, or support notes for the `Experience` mechanic. The package `README.md` remains
...
`mechanics/experience/README.md`, and the specific source document you are changing. If a generated
