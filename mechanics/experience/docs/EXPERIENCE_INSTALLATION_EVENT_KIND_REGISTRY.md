# Installation Event Kind Registry

Version: 1.0.0

## Purpose

Defines canonical event kinds for installation, release, rollback, replay, and operator console.
...
- event-name soup
- unknown production event kind
- silent event coercion
