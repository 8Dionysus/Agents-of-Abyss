...
def load_validator():
    path = ROOT / "mechanics" / "experience" / "scripts" / "validate_experience_v1_7_affective_economy_honor_treasury.py"
...
def test_experience_v17_affective_honor_validator_passes() -> None:
    result = subprocess.run(
        [sys.executable, "mechanics/experience/scripts/validate_experience_v1_7_affective_economy_honor_treasury.py"],
        cwd=ROOT,
        text=True,
        capture_output=True,
    )
