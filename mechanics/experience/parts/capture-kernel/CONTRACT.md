# Capture Kernel Contract

## Center boundary

This part owns the first bounded conversion of lived friction, incidents, candidates, verdict routes, memory gates, and inert projections into reviewable Experience inputs.
...
- friction record, candidate packet, owner route, memory gate, and inert projection boundary.
