...
run `python scripts/validate_experience_wave1.py` and `python -m pytest -q tests/test_experience_wave1.py` for the Wave 1 kernel; run the distillation validator after raw-source moves.
