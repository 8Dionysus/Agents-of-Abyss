...
This part owns installation, deployment, release train, rollout rings, rollback drills, first governed release, semver, and repository landing order grammar.

## Stronger owner split

`mechanics/release-support` owns shared release support; runtime deployment belongs to `abyss-stack`.

## Allowed outputs

- release gate, installation boundary, rollout ring, rollback trigger, repo landing order, and release ritual route.
