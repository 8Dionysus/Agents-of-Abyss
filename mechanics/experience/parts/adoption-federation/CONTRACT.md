# Adoption Federation Contract

## Center boundary

This part owns federation harvest, adoption gates, owner consent, compatibility, rollback, retention, event kinds, state machines, and owner request routing.

## Stronger owner split

target owner repositories accept or reject landing; `aoa-evals` owns adoption proof.
