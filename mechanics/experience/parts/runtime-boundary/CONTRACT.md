...
This part owns living-workspace runtime boundary language, runtime authority resolver constraints, runtime case queues, kind-safe projection, and auto-rollback stop-lines.

## Stronger owner split

`abyss-stack` owns runtime activation, services, storage, and lifecycle; center docs cannot activate runtime.

## Allowed outputs

- runtime stop-line, authority resolver boundary, case queue handoff, projection boundary, and rollback route.
