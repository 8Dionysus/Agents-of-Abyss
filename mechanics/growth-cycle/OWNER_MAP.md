# Growth Cycle Owner Map

Growth Cycle coordinates a reviewed lifecycle. It does not own the stronger
truth produced by any stage.

## Center Owns

`Agents-of-Abyss` owns:

- Growth Cycle law and stage order
- stage vocabulary and stop-lines
- owner split and next-route grammar
- center-side owner-request packets
- package validation that the route remains bounded
...
The center may say which stage should be considered next. It must not say that
the owner-local object has landed, passed proof, entered memory canon, activated
runtime behavior, or become a quest obligation until the owning repository
accepts and validates that claim.
