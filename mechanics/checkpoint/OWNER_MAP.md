...
Checkpoint is a cross-owner mechanic. This map names what the center may say
...
| Public route orientation | route readers to the owning repo | `8Dionysus` |

## One-line rule

AoA owns checkpoint law. `aoa-sdk` operates checkpoint controls. Owner
repositories own local checkpoint meaning.

## Stop-lines

- A checkpoint is not owner acceptance.
- A checkpoint note is not harvest verdict.
- A runtime checkpoint export is not memory canon.
- A re-entry hint is not route authority.
- A derived checkpoint count is not proof.
- A reviewed snapshot is not live activation.
