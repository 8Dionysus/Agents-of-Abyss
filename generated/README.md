...
| [`agents_mesh.min.json`](agents_mesh.min.json) | Root-built | `config/agents_mesh.json` and registered `AGENTS.md` cards | `scripts/agents_mesh/build_agents_mesh_index.py` | `scripts/agents_mesh/validate_agents_mesh_index.py` |
