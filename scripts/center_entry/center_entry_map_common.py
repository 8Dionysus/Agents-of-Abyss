...
VALIDATION_REFS = (
    ...
    "scripts/organ_contract/validate_organ_contract.py",
    "scripts/hygiene/validate_links.py",
    "scripts/hygiene/validate_markdown_shape.py",
    "scripts/hygiene/validate_status_vocabulary.py",
    "scripts/hygiene/build_link_shape_hygiene_index.py",
    "scripts/hygiene/validate_link_shape_hygiene_index.py",
    "scripts/agents_mesh/validate_agents_md_shape.py",
    "scripts/agents_mesh/validate_agents_mesh.py",
    "scripts/agents_mesh/build_agents_mesh_index.py",
    "scripts/agents_mesh/validate_agents_mesh_index.py",
    "scripts/center_entry/validate_entry_surface_sync.py",
    "scripts/center_entry/build_center_entry_map.py",
    "scripts/center_entry/validate_center_entry_map.py",
...
ROUTES: tuple[dict[str, object], ...] = (
    ...
    {
        "route_id": "organ-alignment",
        "route_mode": "organ-alignment",
        "priority": 6,
        "audience": ["maintainer", "downstream-owner", "coding-agent", "reviewer"],
        "need": "align a repository as an AbyssOS organ without taking over its implementation, dispatch, runtime, proof, memory, role, or ToS-authored meaning",
        "surface_ref": "docs/organ-contract/README.md",
        "human_path": [
            "README.md",
            "CHARTER.md",
            "DESIGN.md",
        ...
        "verification_refs": [
            "docs/organ-contract/AGENTS.md",
            "docs/START_HERE_ROUTE_CONTRACT.md",
            "docs/REPO_ROLES.md",
        ],
        "must_not_claim": [
            "organ alignment is SDK activation, routing dispatch, runtime readiness, or owner acceptance",
            "the first cycle replaces local mechanics or owner-local validation",
        ],
    },
    {
