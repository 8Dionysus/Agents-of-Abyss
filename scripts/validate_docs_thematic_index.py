...
def main()->int:
    ...
    if actual!=expected: raise SystemExit('generated docs thematic index does not match docs/thematic_districts.json')
    data=json.loads(actual)
    if data.get('generated_rule')!='Reflects docs/thematic_districts.json; does not author meaning.': raise SystemExit('generated docs thematic index missing generated rule')
