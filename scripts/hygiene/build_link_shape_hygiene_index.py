    ...
    guards = [
        {
            ...
            "status": "active",
            "script": "scripts/hygiene/repair_known_link_drifts.py",
            "source": "config/link_shape_hygiene.json",
        },
        {
            "id": "local-link-validation",
            "status": "active",
            "script": "scripts/hygiene/validate_links.py",
            "source": "Markdown files",
        },
        {
            "id": "markdown-shape-validation",
            "status": "active",
            "script": "scripts/hygiene/validate_markdown_shape.py",
            "source": "config/link_shape_hygiene.json",
        },
        {
            "id": "status-vocabulary-validation",
            "status": "active",
            "script": "scripts/hygiene/validate_status_vocabulary.py",
            "source": "config/link_shape_hygiene.json",
        },
        {
            "id": "generated-freshness-validation",
            "status": "active",
            "script": "scripts/hygiene/validate_generated_freshness.py",
            "source": "config/link_shape_hygiene.json",
        },
        {
            "id": "hygiene-index-validation",
            "status": "active",
            "script": "scripts/hygiene/validate_link_shape_hygiene_index.py",
