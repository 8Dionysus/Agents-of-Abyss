...
MECHANICS: dict[str, dict[str, object]] = {
    ...
    "growth-cycle": {
        "path": "mechanics/growth-cycle/LANDING_LOG.md",
        "required_phrases": (
            "Center Growth Cycle landing",
            "reviewed lifecycle route",
            "hooks, skills, proof, memory, runtime",
    ...
    "boundary-bridge": {
        "path": "mechanics/boundary-bridge/LANDING_LOG.md",
        "required_phrases": (
        ...
        "glob_families": (
            "mechanics/boundary-bridge/parts/*/README.md",
            "mechanics/boundary-bridge/parts/*/CONTRACT.md",
            "mechanics/boundary-bridge/parts/*/VALIDATION.md",
            "mechanics/boundary-bridge/scripts/validate_boundary_bridge_distillation.py",
            "mechanics/boundary-bridge/tests/test_boundary_bridge_distillation.py",
        ),
    },
    "audit": {
        "path": "mechanics/audit/LANDING_LOG.md",
        "required_phrases": (
            "Audit mechanic planted",
            "Center audit grammar and route discipline",
            "legacy audit receipts as active law",
            "proof verdicts, remediation authority, memory truth",
            "Use `mechanics/audit/OWNER_REQUESTS.md` for stronger-owner packets",
        ),
        "required_surfaces": (
        ...
        "glob_families": (
            "mechanics/audit/parts/*/README.md",
            "mechanics/audit/parts/*/CONTRACT.md",
