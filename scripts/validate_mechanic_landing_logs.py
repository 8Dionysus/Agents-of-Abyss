...
MECHANICS: dict[str, dict[str, object]] = {
    ...
    "release-support": {
        "path": "mechanics/release-support/LANDING_LOG.md",
        "required_phrases": (
            "Release-support state-transition distillation",
            "release widened from GitHub-only posture",
            "transition gates, release posture, public support boundaries",
            "no GitHub-only definition of release",
            "sibling acceptance without receipt",
            "hidden rollback debt",
            "carry release proof to `aoa-evals`",
        ),
        "required_surfaces": (
        ...
        "glob_families": (
            "mechanics/release-support/parts/*/README.md",
            "mechanics/release-support/parts/*/CONTRACT.md",
            "mechanics/release-support/parts/*/VALIDATION.md",
            "mechanics/release-support/scripts/validate_release_support_distillation.py",
        ),
    },
    "questbook": {
