...
MECHANICS: dict[str, dict[str, object]] = {
    "agon": {
        ...
        "glob_families": (
            ...
            "mechanics/agon/generated/agon_*.min.json",
            "mechanics/agon/schemas/agon-*.schema.json",
            "mechanics/agon/config/agon_*.seed.json",
            "mechanics/agon/examples/agon_*.example.json",
            "mechanics/agon/scripts/*agon*.py",
            "mechanics/agon/tests/test_agon_*.py",
        ),
    },
    "experience": {
