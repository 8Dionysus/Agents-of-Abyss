...
BUILDER_PATH = REPO_ROOT / "scripts" / "owner_requests" / "build_owner_request_queue.py"


def load_builder():
    spec = importlib.util.spec_from_file_location("build_owner_request_queue", BUILDER_PATH)
    if spec is None or spec.loader is None:
        raise RuntimeError("cannot load scripts/owner_requests/build_owner_request_queue.py")
