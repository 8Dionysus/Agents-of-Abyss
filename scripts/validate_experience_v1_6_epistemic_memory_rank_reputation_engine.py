...
DOC_PATH = ROOT / "docs" / "EXPERIENCE_V1_6_EPISTEMIC_MEMORY_RANK_REPUTATION_ENGINE.md"
...
EXPECTED_PREDECESSORS = [
    ...
    "docs/AGON_RETENTION_OWNER_HANDOFFS.md",
    "docs/AGON_RANK_JURISDICTION_MODEL.md",
