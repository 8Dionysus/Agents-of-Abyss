...
DOC_PATH = ROOT / "docs" / "EXPERIENCE_V1_8_CONTEXT_ROUTING_NERVOUS_SYSTEM.md"
...
EXPECTED_PREDECESSORS = [
    ...
    "docs/EXPERIENCE_AUTHORITY_RESOLVER.md",
    ...
    "docs/AGON_COURT_MEMO_STATS_PREBINDING_HANDOFF.md",
