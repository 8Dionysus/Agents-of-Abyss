...
try:
    ...
    from scripts.agents_mesh.agents_mesh_common import DEFAULT_GENERATED, build_index, dump_min_json, repo_root_from
...
def main() -> int:
    ...
    if args.check:
        ...
        if current != data:
            raise SystemExit("generated AGENTS mesh index is stale; run python scripts/agents_mesh/build_agents_mesh_index.py")
