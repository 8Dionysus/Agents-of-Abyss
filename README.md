...
- **Agon move owner binding**: [docs/AGON_MOVE_OWNER_BINDING](docs/AGON_MOVE_OWNER_BINDING.md), [docs/AGON_MOVE_BINDING_MATRIX_MODEL](docs/AGON_MOVE_BINDING_MATRIX_MODEL.md), [docs/AGON_OWNER_REPO_REQUESTS](docs/AGON_OWNER_REPO_REQUESTS.md), [docs/AGON_PRE_PROTOCOL_STOP_LINES](docs/AGON_PRE_PROTOCOL_STOP_LINES.md), [docs/AGON_WAVE4_LANDING](docs/AGON_WAVE4_LANDING.md), [generated/agon_move_owner_binding_registry.min.json](generated/agon_move_owner_binding_registry.min.json), `python scripts/build_agon_move_owner_binding_registry.py --check`, `python scripts/validate_agon_move_owner_bindings.py`, and `python -m pytest -q tests/test_agon_move_owner_bindings.py`
- **Agon gate routing handoff**: [docs/AGON_GATE_ROUTING_HANDOFF](docs/AGON_GATE_ROUTING_HANDOFF.md), [docs/AGON_GATE_ROUTING_OWNER_REQUEST](docs/AGON_GATE_ROUTING_OWNER_REQUEST.md), [docs/AGON_GATE_ROUTING_STOP_LINES](docs/AGON_GATE_ROUTING_STOP_LINES.md), [docs/AGON_WAVE5_CENTER_HANDOFF](docs/AGON_WAVE5_CENTER_HANDOFF.md), [generated/agon_gate_routing_handoff_request.min.json](generated/agon_gate_routing_handoff_request.min.json), `python scripts/build_agon_gate_routing_handoff_request.py --check`, `python scripts/validate_agon_gate_routing_handoff_request.py`, and `python -m pytest -q tests/test_agon_gate_routing_handoff_request.py`
- **Agon trial playbook handoff**: [docs/AGON_TRIAL_PLAYBOOK_HANDOFF](docs/AGON_TRIAL_PLAYBOOK_HANDOFF.md), [docs/AGON_TRIAL_PLAYBOOK_OWNER_REQUEST](docs/AGON_TRIAL_PLAYBOOK_OWNER_REQUEST.md), [docs/AGON_TRIAL_PLAYBOOK_STOP_LINES](docs/AGON_TRIAL_PLAYBOOK_STOP_LINES.md), [docs/AGON_WAVE6_CENTER_HANDOFF](docs/AGON_WAVE6_CENTER_HANDOFF.md), [generated/agon_trial_playbook_request.min.json](generated/agon_trial_playbook_request.min.json), `python scripts/build_agon_trial_playbook_request.py --check`, `python scripts/validate_agon_trial_playbook_request.py`, and `python -m pytest -q tests/test_agon_trial_playbook_request.py`
- **Experience v1.5 epistemic duel model-of-other forge**: [docs/EXPERIENCE_V1_5_EPISTEMIC_DUEL_MODEL_OF_OTHER_FORGE](docs/EXPERIENCE_V1_5_EPISTEMIC_DUEL_MODEL_OF_OTHER_FORGE.md), [examples/experience_v1_5_epistemic_duel_model_of_other_forge.example.json](examples/experience_v1_5_epistemic_duel_model_of_other_forge.example.json), [schemas/experience-v1-5-epistemic-duel-model-of-other-forge.schema.json](schemas/experience-v1-5-epistemic-duel-model-of-other-forge.schema.json), `python scripts/validate_experience_v1_5_epistemic_duel_model_of_other_forge.py`, and `python -m pytest -q tests/test_experience_v1_5_epistemic_duel_model_of_other_forge.py`
...
- **Agon move owner binding** that gives each lawful move explicit future owner gravity without promoting owner requests into landed practice, workflow, proof, routing, scenario, memory, stats, actor, or ToS authority
- **Agon gate routing handoff** that lets `aoa-routing` emit thin pre-protocol gate candidates and stop-line hints without opening a live arena, moving Agon law into routing, or granting verdict, scar, retention, rank, runtime, or ToS authority
- **Agon trial playbook handoff** that asks `aoa-playbooks` to land recurring mechanical trial choreography without opening a live arena, moving Agon law into scenario composition, or granting verdict, scar, retention, rank, runtime, or ToS authority
- **Experience v1.5 epistemic duel model-of-other forge** that names sealed model-of-other prediction, reveal scoring, countermodel pressure, revision, and bifurcation quality without opening a live duel, activating runtime, granting assistant contestant authority, issuing truth verdicts, mutating standing or memory, or promoting ToS/KAG canon
