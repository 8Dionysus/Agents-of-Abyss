...
| Experience | staged center contracts through active parts, Wave 1-5 provenance, and v1.2 to v2.0 legacy raw sources | live workspace runtime, hidden memory sovereignty, or owner-local activation | `mechanics/experience/README.md`, `mechanics/experience/PARTS.md`, and `mechanics/experience/legacy/INDEX.md` |
