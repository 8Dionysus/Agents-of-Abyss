...
| Quest/RPG reflection | public quest model, lifecycle quest board, and adjunct progression reading layer | runtime ledger, global score, or hidden ontology | `QUESTBOOK.md`, `quests/`, `mechanics/questbook/docs/QUESTBOOK_MODEL.md`, `mechanics/rpg/docs/RPG_LAYER_MODEL.md` |
