...
- **pre-Agon holding posture**: [docs/AGON_PREPARATION_POSTURE](docs/AGON_PREPARATION_POSTURE.md)
...
- **pre-Agon preparation** that keeps Agon inside the center as a provisional future protocol contour, not a new sibling repo, not ToS canon, and not runtime substrate
