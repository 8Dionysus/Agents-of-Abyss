...
This card applies to `docs/legacy/` and all descendants unless a nearer `AGENTS.md` narrows the path.

## Role

`docs/legacy/` holds compatibility aliases, superseded flat docs, and old routes retained for safe navigation.
...
- Legacy files must point forward and should not accumulate new doctrine.
