...
This card applies to `docs/landings/` and all descendants unless a nearer `AGENTS.md` narrows the path.

## Role

`docs/landings/` holds wave receipts, seed manifests, landing notes, and checked historical records.
...
- A landing receipt is history, not proof that owner-local implementation exists.
