...
|---|---|---|---|---|---|---|
| `Agents-of-Abyss` | none as a host-consumed bundle by default | center doctrine and route law | no fake ABI for living doctrine; route changes use docs validators and decision review | generated center exports need their own class before host consumption | agent orientation | owns doctrine, owner split, and stop-lines, not enforcement or sibling artifacts |
