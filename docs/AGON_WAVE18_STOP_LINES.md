# Agon Wave18 Stop Lines

Wave XVIII stop-lines: no direct canon write, no automatic canonization, no branch creation, no doctrine rewrite, no hidden scheduler.
