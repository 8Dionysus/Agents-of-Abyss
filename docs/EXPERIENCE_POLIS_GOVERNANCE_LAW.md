# Experience Polis Governance Law

Status: seed v0.8.0  
Repo landing: `Agents-of-Abyss`  
Layer: Experience Polis Governance

## Purpose

Defines the laws that decide who may govern disputes across experience, adoption, deployment and arena-derived changes.
...
- Governance decisions must be visible, reviewable and authority-bound.
- Appeal and veto are not certification; they are decision controls.
- Precedent is advisory until owner-local adoption accepts it.

## Minimal flow

1. Open governance case from disputed experience/adoption/release/trial event.
2. Check authority, conflicts of interest and quorum.
3. Issue decision, stay, veto, appeal ruling or charter amendment.
4. Route consequences to owner-local repos and schedule audit/retention.

## Owner notes

- Center owns law and registry; owners still own local meaning.
- Tree-of-Sophia receives dossiers only after derived gates.
