...
This card applies to `docs/postmortems/` and all descendants unless a nearer `AGENTS.md` narrows the path.

## Role

`docs/postmortems/` holds failure analysis, repair notes, and sober retrospectives.
...
- Postmortems preserve repair knowledge without turning failure traces into doctrine catalogs.
