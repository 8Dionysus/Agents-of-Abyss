# Experience v1.0 Installation and First Sovereign Release

Version: 1.0.0

## Purpose

Defines the full v1.0 installable contour: landing order, migration, smoke gates, operator console, first assistant office, release seal, replay, rollback, and watch.
...
- v1.0 scope
- sovereign release contour
- top-level invariants

## Must not do

- become a runtime service
- bypass owners
- write directly to ToS
