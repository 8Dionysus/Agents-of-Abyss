...
Then use [`MECHANICS`](../mechanics/README.md) as the single branch point for center-level processes: method/growth, recurrence/return/continuity, Agon, Experience, antifragility/subtraction, quest/RPG reflection, boundary bridge and ToS support, release posture, machine companions, and related stop-lines.
...
| Agon | [`MECHANICS`](../mechanics/agon/README.md), [`DIRECTION`](../mechanics/agon/DIRECTION.md), [`PARTS`](../mechanics/agon/PARTS.md), [`PROVENANCE`](../mechanics/agon/PROVENANCE.md), [`AGON_LANDING_LOG`](../mechanics/agon/LANDING_LOG.md) | pressure, lawful move, arena, packet, verdict, retention, rank, school, canon, or owner-binding law is involved |
...
| Antifragility and subtraction | [`MECHANICS`](../mechanics/antifragility/README.md), [`DIRECTION`](../mechanics/antifragility/DIRECTION.md), [`PARTS`](../mechanics/antifragility/PARTS.md), [`PROVENANCE`](../mechanics/antifragility/PROVENANCE.md), [`VIA_NEGATIVA`](../mechanics/antifragility/docs/VIA_NEGATIVA.md), [`ANTI_AUTHORITY_RULES`](../mechanics/antifragility/docs/ANTI_AUTHORITY_RULES.md), [`ONE_IN_ONE_OUT`](../mechanics/antifragility/docs/ONE_IN_ONE_OUT.md) | stress, degraded mode, pruning, or authority inflation must be handled |
| Questbook and RPG | [`model-spine`](../mechanics/questbook/parts/model-spine/README.md), [`lifecycle-law`](../mechanics/questbook/parts/lifecycle-law/README.md), [`RPG parts`](../mechanics/rpg/PARTS.md), [`source-boundary`](../mechanics/rpg/parts/source-boundary/README.md), [`vocabulary-overlay`](../mechanics/rpg/parts/vocabulary-overlay/README.md) | obligations, questlines, progression, or adjunct campaign vocabulary is needed |
| Boundary bridge and ToS support | [`boundary-bridge`](../mechanics/boundary-bridge/README.md), [`PARTS`](../mechanics/boundary-bridge/PARTS.md), [`tos-support`](../mechanics/boundary-bridge/parts/tos-support/README.md), [`COUNTERPART_BRIDGE`](../mechanics/boundary-bridge/docs/COUNTERPART_BRIDGE.md), [`WITNESS_COMPOST`](../mechanics/boundary-bridge/docs/WITNESS_COMPOST.md) | AoA supports cross-owner work while preserving source-owned meaning and owner-local authority |
| Release and audit | [`release-support`](../mechanics/release-support/README.md), [`PARTS`](../mechanics/release-support/PARTS.md), [`PUBLIC_SUPPORT_POSTURE`](../mechanics/release-support/docs/PUBLIC_SUPPORT_POSTURE.md), [`DIRECTION_SURFACES`](../mechanics/release-support/docs/DIRECTION_SURFACES.md), [`FEDERATION_RELEASE_PROTOCOL`](../mechanics/release-support/docs/FEDERATION_RELEASE_PROTOCOL.md), [`RELEASING`](../mechanics/release-support/docs/RELEASING.md), [`CODEX_AUDIT_PROTOCOL`](audits/CODEX_AUDIT_PROTOCOL.md) | a transition, public claim, release, or audit route needs verification |
