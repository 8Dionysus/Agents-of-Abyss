...
| Questbook and RPG | [`model-spine`](../mechanics/questbook/parts/model-spine/README.md), [`lifecycle-law`](../mechanics/questbook/parts/lifecycle-law/README.md), [`RPG_LAYER_MODEL`](../mechanics/rpg/docs/RPG_LAYER_MODEL.md), [`RPG_ARCHITECTURE_RFC`](../mechanics/rpg/docs/RPG_ARCHITECTURE_RFC.md) | obligations, questlines, progression, or adjunct campaign vocabulary is needed |
