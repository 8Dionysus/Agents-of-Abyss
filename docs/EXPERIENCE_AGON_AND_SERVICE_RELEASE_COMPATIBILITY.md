# Agon and Service Release Compatibility

Version: 1.0.0

## Purpose

Defines how agonic scars and assistant versions coexist in the first sovereign release.
...
- kind-safe compatibility
- scar/version separation
- cross-kind guard
