...
This card applies to `docs/experience/` and all descendants unless a nearer `AGENTS.md` narrows the path.

## Role

`docs/experience/` holds old or transitional Experience center records that are not package-canonical.
...
- Canonical Experience mechanic doctrine belongs in `mechanics/experience/`.
