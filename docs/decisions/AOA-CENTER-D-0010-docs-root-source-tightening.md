...
- Surface classes: docs district, root surface, repository routing
- Center facets: docs guardrail
- Mechanic parents: none
- Guard families: docs hygiene, center route law
