...
- Surface classes: decision record, memory/writeback, validation guard
- Center facets: decision memory
- Mechanic parents: cross-mechanic
- Guard families: memory writeback, docs hygiene
