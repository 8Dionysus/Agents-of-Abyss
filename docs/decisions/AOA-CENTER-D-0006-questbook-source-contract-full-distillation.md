...
- Surface classes: mechanic package, schema/contract, validation guard
- Center facets: questbook
- Mechanic parents: questbook
- Guard families: quest contract, schema validation
