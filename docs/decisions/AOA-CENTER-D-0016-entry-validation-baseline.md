...
- Surface classes: docs district, validation guard, root surface
- Center facets: entry surface
- Mechanic parents: none
- Guard families: center route law, release/tooling
