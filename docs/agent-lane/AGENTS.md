...
This card applies to `docs/agent-lane/` and all descendants unless a nearer `AGENTS.md` narrows the path.

## Role

`docs/agent-lane/` holds agent-facing references, root-agent supplements, and explicit agent workflow guidance.
...
- Do not use this district to override root law or hide private memory.
