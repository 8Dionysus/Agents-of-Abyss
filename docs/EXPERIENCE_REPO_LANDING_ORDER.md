# Experience Repo Landing Order

Version: 1.0.0

## Purpose

Defines the sequence in which the seed should land across the sibling workspace.
...
- parallel blind landing
- routing meaning theft
- source ownership theft
