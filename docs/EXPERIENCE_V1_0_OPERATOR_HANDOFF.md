# v1.0 Operator Handoff

Version: 1.0.0

## Purpose

Defines the compact handoff to the operator after install: what changed, where to inspect, what can be rolled back.
