# Agents-of-Abyss Memo Port

This is the center-local memory port for Agents-of-Abyss.

Use it for candidates, receipts, exports, and local notes that should be visible
to future agents without making the center absorb `aoa-memo` authority.
...
| `local/` | center-local memory notes that should remain local |
