# AOA-Q-EXP-0081: Council Session Kernel
...
Forge the `council session kernel` surface for the experience mechanic without creating a new repository or stealing owner-local meaning.
