# AOA-Q-EXP-0092: Conflict Of Interest Handling
...
Forge the `conflict of interest handling` surface for the experience mechanic without creating a new repository or stealing owner-local meaning.

## Acceptance

- authority check exists;
- evidence refs are required;
- Codex cannot approve or vote;
