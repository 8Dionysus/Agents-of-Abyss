...
6. Read the local district README before changing `generated/`, `scripts/`, `schemas/`, `tests/`, `config/`, `examples/`, `manifests/`, or `quests/`.
7. Read [ROADMAP](ROADMAP.md) for declared direction and current phase.
8. Check generated capsules before claiming the change is complete.
