...
`.agents/spark/` is the fast session lane for GPT-5.3-Codex-Spark style work in the
...
| Rule | Meaning |
|---|---|
| one scenario | choose exactly one registered scenario from `.agents/spark/registry.json` |
